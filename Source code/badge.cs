    ...
    public partial class badge : Form
    {
            ...
            t:
                ...
                for (int f = 0; f < dataGridView2.Rows.Count; f++)
                {
                    if (Convert.ToBoolean(dataGridView1.Rows[i].Cells[0].Value) == true && Convert.ToInt16(dataGridView1.Rows[i].Cells[1].Value) == Convert.ToInt16(dataGridView2.Rows[f].Cells[1].Value))
                    {
                        ...
                        //dataGridView1.Rows[f - 1].Cells["Column1"].Value = true;
        ...
        public void fill_imprim() {
            ...
            for (int j = 0; j < dataGridView2.Rows.Count-1 ; j++)
            {
                ...
                {
                    adp.InsertCommand = new SqlCommand("insert into imprim(id,nom,cin,etabl,dat_deb,dat_fin,servi) values(@iDD,@NomM,@CinN,@EtablL,@Dat_dD,@Dat_fF,@ServV)", con);
                ...
                if (dialogResult1 == DialogResult.Yes)
                {
                    ...
                    a:
                        ...
                        if (Convert.ToBoolean(dataGridView2.Rows[i].Cells["Column2"].Value) == true)
                        {
                            ...
                            cmd = new SqlCommand("update stagiaire set [BADGE]='" + true + "' where idSTAGIAIRE='" + v + "'", con);
                            cmd1 = new SqlCommand("select BADGE from stagiaire where idSTAGIAIRE='" + v + "'", con);
                            ...
                            {
                                DialogResult dialogResult = MessageBox.Show(this, "le stagiaire " + dataGridView2.Rows[i].Cells[2].Value.ToString() + " a deja pris un badge ! imprimer un nouveau ?", "ATTENTION !!", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2);
